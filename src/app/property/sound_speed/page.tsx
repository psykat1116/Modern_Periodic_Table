...
import { SoundSpeed } from "@/components/Collection";
  ...
  return (
    <>
      ...
      >
        {RowOneElem.map((e) => {
          return (
            e.material_properties?.sound_speed && (
              <SoundSpeed
        ...
        {RowSixElem[0].material_properties?.sound_speed && (
          <SoundSpeed
        ...
        {RowSixElem[1].material_properties?.sound_speed && (
          <SoundSpeed
        ...
        {RowSevenElem[0].material_properties?.sound_speed && (
          <SoundSpeed
        ...
        {RowSevenElem[1].material_properties?.sound_speed && (
          <SoundSpeed
