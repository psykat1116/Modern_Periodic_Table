...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-2 w-full px-2">
      ...
      <div
        className={`w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 pb-2 overflow-y-scroll gap-2`}
      >
        {RowOneElem.map((e) => {
          return (
            e.thermodynamic_properties?.boiling_point && (
              <BoilingPoint
        ...
        {RowSixElem[0].thermodynamic_properties?.boiling_point && (
          <BoilingPoint
        ...
        {RowSixElem[1].thermodynamic_properties?.boiling_point && (
          <BoilingPoint
