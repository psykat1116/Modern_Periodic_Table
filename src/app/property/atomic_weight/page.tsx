...
const Page = () => {
  ...
  return (
    <div className="flex flex-col relative w-full gap-2 px-2">
      <div
        className={cn(
      ...
      <div
        className={`w-full grid pb-2 overflow-y-scroll gap-2 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4`}
      >
        {RowOneElem.map((e) => {
          return (
