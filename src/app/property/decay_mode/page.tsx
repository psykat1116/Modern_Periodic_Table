...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-2 w-full px-2">
      <div
        className={`w-full sm:text-4xl flex justify-center items-center font-lora p-2 ${
      ...
      <div
        className={`w-full grid grid-cols-3 pb-2 overflow-y-scroll gap-2 z-[5] max-sm:grid-cols-1 max-md:grid-cols-2`}
      >
        {RowOneElem.map((e) => {
          return (
