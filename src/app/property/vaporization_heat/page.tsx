  ...
  return (
    <div className="flex flex-col gap-2 px-2 w-full">
      ...
      >
        ...
        <Link
          href="/statistics/vaporization_heat"
          className={cn(
      ...
      <div
        className={`w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 pb-2 overflow-y-scroll gap-2 text-sm lg:text-base`}
      >
        {RowOneElem.map((e) => {
          return (
            e.thermodynamic_properties?.vaporization_heat && (
              <VaporizationHeat
