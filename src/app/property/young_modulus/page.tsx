  ...
  return (
    <>
      ...
      >
        ...
        {RowSixElem[0].material_properties?.young_modulus && (
          <YoungModulus
        ...
        {RowSixElem[1].material_properties?.young_modulus && (
          <YoungModulus
        ...
        {RowSevenElem[0].material_properties?.young_modulus && (
          <YoungModulus
        ...
        {RowSevenElem[1].material_properties?.young_modulus && (
          <YoungModulus
