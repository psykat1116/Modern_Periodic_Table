...
import labelData, { superconductData } from "@/constant/GraphData/SuperconductingPoint";
...
const Page = () => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Superconducting Point of Elements",
      },
    },
  };
  const data = {
    ...
    datasets: [
      {
        label: "Superconducting Point (K)",
        data: superconductData,
