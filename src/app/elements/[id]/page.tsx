...
import HydrogenAtom from "@/components/AtomStructures_3d/HydrogenAtom";
import AtomStructureRenderer from "@/components/AtomStructureRenderer";
      ...
      >
        ...
        {!elem ? (
          ...
          <div className="relative w-full h-auto my-2 p-6 flex justify-between items-start z-[5] max-sm:flex-col">
            ...
            >
              <div>
                <AtomStructureRenderer theme={theme} id={id} containerSize={{ width: ((window.innerWidth)*1)/3, height: ((window.innerHeight) * 2)/3 }}/>
              </div>
