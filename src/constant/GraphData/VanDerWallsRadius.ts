...
RowOneElem.forEach((elem) => {
  if (elem.atomic_properties.van_der_walls_radius) {
    data.push({
      ...
      value: elem.atomic_properties.van_der_walls_radius,
    });
  }
});
...
if (RowSixElem[0].atomic_properties.van_der_walls_radius) {
  data.push({
    ...
    value: RowSixElem[0].atomic_properties.van_der_walls_radius,
  });
}
if (RowSixElem[1].atomic_properties.van_der_walls_radius) {
  data.push({
    label: RowSixElem[1].general_properties.symbol,
    value: RowSixElem[1].atomic_properties.van_der_walls_radius,
  });
}
...
if (RowSevenElem[0].atomic_properties.van_der_walls_radius) {
  data.push({
    ...
    value: RowSevenElem[0].atomic_properties.van_der_walls_radius,
  });
}
if (RowSevenElem[1].atomic_properties.van_der_walls_radius) {
  data.push({
    label: RowSevenElem[1].general_properties.symbol,
    value: RowSevenElem[1].atomic_properties.van_der_walls_radius,
  });
}
