...
RowOneElem.forEach((elem) => {
  if (elem.material_properties?.brinell_hardness) {
    data.push({
      ...
      value: elem.material_properties.brinell_hardness,
    });
  }
});
...
if (RowSixElem[0].material_properties?.brinell_hardness) {
  data.push({
    ...
    value: RowSixElem[0].material_properties.brinell_hardness,
  });
}
if (RowSixElem[1].material_properties?.brinell_hardness) {
  data.push({
    label: RowSixElem[1].general_properties.symbol,
    value: RowSixElem[1].material_properties.brinell_hardness,
  });
}
...
if (RowSevenElem[0].material_properties?.brinell_hardness) {
  data.push({
    ...
    value: RowSevenElem[0].material_properties.brinell_hardness,
  });
}
if (RowSevenElem[1].material_properties?.brinell_hardness) {
  data.push({
    label: RowSevenElem[1].general_properties.symbol,
    value: RowSevenElem[1].material_properties.brinell_hardness,
  });
}
