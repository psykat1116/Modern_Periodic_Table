...
if (RowSixElem[0].material_properties?.vickers_hardness) {
  ...
  vhardData.push(RowSixElem[0].material_properties.vickers_hardness);
}
if (RowSixElem[1].material_properties?.vickers_hardness) {
  labelData.push(RowSixElem[1].general_properties.symbol);
  vhardData.push(RowSixElem[1].material_properties.vickers_hardness);
}
...
if (RowSevenElem[0].material_properties?.vickers_hardness) {
  ...
  vhardData.push(RowSevenElem[0].material_properties.vickers_hardness);
}
if (RowSevenElem[1].material_properties?.vickers_hardness) {
  labelData.push(RowSevenElem[1].general_properties.symbol);
  vhardData.push(RowSevenElem[1].material_properties.vickers_hardness);
}
