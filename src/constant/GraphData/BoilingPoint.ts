...
RowOneElem.forEach((elem) => {
  if (elem.thermodynamic_properties?.boiling_point) {
    ...
    bpData.push(elem.thermodynamic_properties.boiling_point);
  }
});
...
if (RowSixElem[0].thermodynamic_properties?.boiling_point) {
  ...
  bpData.push(RowSixElem[0].thermodynamic_properties.boiling_point);
}
if (RowSixElem[1].thermodynamic_properties?.boiling_point) {
  labelData.push(RowSixElem[1].general_properties.symbol);
  bpData.push(RowSixElem[1].thermodynamic_properties.boiling_point);
}
...
if (RowSevenElem[0].thermodynamic_properties?.boiling_point) {
  ...
  bpData.push(RowSevenElem[0].thermodynamic_properties.boiling_point);
}
if (RowSevenElem[1].thermodynamic_properties?.boiling_point) {
  labelData.push(RowSevenElem[1].general_properties.symbol);
  bpData.push(RowSevenElem[1].thermodynamic_properties.boiling_point);
}
