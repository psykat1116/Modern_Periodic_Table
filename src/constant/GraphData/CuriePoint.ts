...
RowOneElem.forEach((elem) => {
  if (elem.electromagnetic_properties?.curie_point) {
    data.push({
      ...
      value: elem.electromagnetic_properties.curie_point,
    });
  }
});
...
if (RowSixElem[0].electromagnetic_properties?.curie_point) {
  data.push({
    ...
    value: RowSixElem[0].electromagnetic_properties.curie_point,
  });
}
if (RowSixElem[1].electromagnetic_properties?.curie_point) {
  data.push({
    label: RowSixElem[1].general_properties.symbol,
    value: RowSixElem[1].electromagnetic_properties.curie_point,
  });
}
...
if (RowSevenElem[0].electromagnetic_properties?.curie_point) {
  data.push({
    ...
    value: RowSevenElem[0].electromagnetic_properties.curie_point,
  });
}
if (RowSevenElem[1].electromagnetic_properties?.curie_point) {
  data.push({
    label: RowSevenElem[1].general_properties.symbol,
    value: RowSevenElem[1].electromagnetic_properties.curie_point,
  });
}
