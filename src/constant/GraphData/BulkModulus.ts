...
RowOneElem.forEach((elem) => {
  if (elem.material_properties?.bulk_modulus) {
    data.push({
      ...
      value: elem.material_properties.bulk_modulus,
    });
  }
});
...
if (RowSixElem[0].material_properties?.bulk_modulus) {
  data.push({
    ...
    value: RowSixElem[0].material_properties.bulk_modulus,
  });
}
if (RowSixElem[1].material_properties?.bulk_modulus) {
  data.push({
    label: RowSixElem[1].general_properties.symbol,
    value: RowSixElem[1].material_properties.bulk_modulus,
  });
}
...
if (RowSevenElem[0].material_properties?.bulk_modulus) {
  data.push({
    ...
    value: RowSevenElem[0].material_properties.bulk_modulus,
  });
}
if (RowSevenElem[1].material_properties?.bulk_modulus) {
  data.push({
    label: RowSevenElem[1].general_properties.symbol,
    value: RowSevenElem[1].material_properties.bulk_modulus,
  });
}
