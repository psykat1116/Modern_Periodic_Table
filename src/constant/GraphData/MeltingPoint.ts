...
RowOneElem.forEach((elem) => {
  if (elem.thermodynamic_properties?.melting_point) {
    data.push({
      ...
      value: elem.thermodynamic_properties.melting_point,
    });
  }
});
...
if (RowSixElem[0].thermodynamic_properties?.melting_point) {
  data.push({
    ...
    value: RowSixElem[0].thermodynamic_properties.melting_point,
  });
}
if (RowSixElem[1].thermodynamic_properties?.melting_point) {
  data.push({
    label: RowSixElem[1].general_properties.symbol,
    value: RowSixElem[1].thermodynamic_properties.melting_point,
  });
}
...
if (RowSevenElem[0].thermodynamic_properties?.melting_point) {
  data.push({
    ...
    value: RowSevenElem[0].thermodynamic_properties.melting_point,
  });
}
if (RowSevenElem[1].thermodynamic_properties?.melting_point) {
  data.push({
    label: RowSevenElem[1].general_properties.symbol,
    value: RowSevenElem[1].thermodynamic_properties.melting_point,
  });
}
