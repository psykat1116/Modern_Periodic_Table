...
interface VolumeMagneticSuspectibility {
...
const VolumeMagneticSuspectibility = ({
  atomic_number,
      ...
      {volume_magnetic_suspectibility && (
        <Link
          ...
          dangerouslySetInnerHTML={{
            __html: xss(volume_magnetic_suspectibility),
          }}
        ></Link>
      )}
    </div>
...
export default VolumeMagneticSuspectibility;
