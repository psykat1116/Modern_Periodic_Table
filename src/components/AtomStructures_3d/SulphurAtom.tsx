...
const SulphurAtom = ({ theme, containerSize }: { theme: string, containerSize: { width: number, height: number } }) => {
  ...
  useEffect(() => {
    ...
    const sulfurNucleus = new THREE.Mesh(nucleusGeometry, nucleusMaterial);
    ...
    const animate = function () {
      ...
      // Rotate the sulfur nucleus
      sulfurNucleus.rotation.x += 0.01;
      sulfurNucleus.rotation.y += 0.01;
