...
const NeonAtom: React.FC<NeonAtomProps> = ({ theme, containerSize }) => {
  ...
  useEffect(() => {
    ...
    const neonNucleus = new THREE.Mesh(nucleusGeometry, nucleusMaterial);
    ...
    const animate = function () {
      ...
      // Rotate the neon nucleus
      neonNucleus.rotation.x += 0.01;
      neonNucleus.rotation.y += 0.01;
